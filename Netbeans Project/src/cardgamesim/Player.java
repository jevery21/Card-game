...
public class Player extends Thread {
        ...
        while(CardGame.getWinner() == -1)
        {
            ...
            else if(!(CardGame.isDeckEmpty(this.playerNo)))
            {
                ...
                temp = "player " + this.playerNo + " discards a " 
                        + cardDiscard.getNumber() + " from deck " 
                        + this.rightDeckNo;
     ...
     * in the hand and calls the method to finish the game, if so.
     */
    private void hasWon()
    {
        ...
        {
            if (c.getNumber() == this.cardPreference)
            {
                numberOfEqualCards ++;
            }
        }
    ...
    private Card getCardToBeDiscarded()
    {
        ...
        switch (this.strategy)
        {
            case 2:
                ...
                // HashMap over HashTable as no need for synchronisation
                ...
                this.strategy = 1;
                // Continue to case 0 to choose card to remove from new
                // preferences.
                
            case 1: // Default strategy where player index-number card.
